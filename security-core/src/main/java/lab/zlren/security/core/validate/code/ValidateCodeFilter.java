 ...
 * @date 17/10/15
 */
public class ValidateCodeFilter extends OncePerRequestFilter { // implements InitializingBean 实现这个接口的目的就是初始化urls
    ...
    private void validate(ServletWebRequest servletWebRequest) throws ServletRequestBindingException {
        ...
        ImageCode imageCodeInSession = (ImageCode) sessionStrategy.getAttribute(servletWebRequest, SESSION_KEY);
